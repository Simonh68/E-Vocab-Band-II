...
const C=(id,level,group,en,he,descEn,descHe,core)=>({id,level,group,en,he,descEn,descHe,image:`covers/${id}.webp`,simple:group==='ES',scenes:expand(core,level===1?4:level===2?6:8,group==='ES')});
