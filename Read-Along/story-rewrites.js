...
const narrativeRevisions={
 ...
 'new-3-a1-first-job-interview':[
  [['Noa arrived ten minutes early','נועה הגיעה עשר דקות מוקדם'],['at a neighborhood bookstore.','לחנות ספרים שכונתית.']],
  [['In her notebook,','במחברתה,'],['she had listed three skills','היא רשמה שלוש מיומנויות'],['the job required.','שנדרשו לעבודה.']],
  [['Her hands shook','ידיה רעדו'],['when the manager asked her','כאשר המנהל ביקש ממנה'],['to help a young customer.','לעזור ללקוח צעיר.']],
  [['The boy wanted a short soccer book,','הילד רצה ספר קצר על כדורגל,'],['but Noa had not prepared','אך נועה לא התכוננה'],['for this request.','לבקשה הזאת.']],
  [['Noa asked his age','נועה שאלה לגילו'],['and what kind of stories','ולאיזה סוג של סיפורים'],['he usually enjoyed.','הוא נהנה בדרך כלל.']],
  [['His answer led her','תשובתו הובילה אותה'],['to a thin adventure book','לספר הרפתקה דק'],['beside the sports shelf.','ליד מדף הספורט.']],
  [['The price sticker was missing,','מדבקת המחיר הייתה חסרה,'],['and the shop computer','ומחשב החנות'],['used an unfamiliar system.','השתמש במערכת שלא הכירה.']],
  [['“I do not know this system yet,','״עדיין איני מכירה את המערכת הזאת,'],['but I can learn,”','אבל אני יכולה ללמוד,״'],['Noa told the manager.','אמרה נועה למנהל.']],
  [['She watched one search,','היא צפתה בחיפוש אחד,'],['then entered the title herself.','ואז הזינה את הכותרת בעצמה.']],
  [['The correct price appeared,','המחיר הנכון הופיע,'],['and the boy carried the book','והילד נשא את הספר'],['to the counter.','אל הדלפק.']],
  [['The manager invited Noa','המנהל הזמין את נועה'],['to a training shift','למשמרת הכשרה'],['because she had been honest','מפני שהייתה כנה'],['and learned quickly.','ולמדה במהירות.']],
  [['On that shift,','באותה משמרת,'],['her notebook held the computer steps','מחברתה הכילה את שלבי העבודה במחשב'],['instead of memorized interview answers.','במקום תשובות משוננות לריאיון.']]
 ],
 'new-3-a1-shift-exchange':[
  [['At 3:20 on Friday,','ביום שישי בשעה 3:20,'],['Roni learned that her cousin’s party','רוני גילתה שהמסיבה של בת דודתה'],['had moved to that afternoon.','הוקדמה לאותו אחר הצהריים.']],
  [['Her bakery shift','המשמרת שלה במאפייה'],['began at four.','התחילה בשעה ארבע.']],
  [['She asked Amir in a message','היא ביקשה מאמיר בהודעה'],['to take the shift.','לקחת את המשמרת.']],
  [['“I can probably cover it,”','״כנראה שאוכל להחליף אותך,״'],['he replied.','הוא השיב.']],
  [['Roni sent a thumbs-up','רוני שלחה סימן של אגודל מורם'],['but did not contact the manager.','אך לא פנתה למנהלת.']],
  [['At 3:55,','בשעה 3:55,'],['the manager called:','המנהלת התקשרה:'],['the front counter was empty.','הדלפק הקדמי היה ריק.']],
  [['Amir thought the manager','אמיר חשב שהמנהלת'],['would confirm the exchange,','תאשר את ההחלפה,'],['so he had stayed at soccer practice.','ולכן נשאר באימון הכדורגל.']],
  [['Roni stood at the bus stop','רוני עמדה בתחנת האוטובוס'],['with a wrapped gift in her hands.','ובידיה מתנה עטופה.']],
  [['She could blame Amir','היא יכלה להאשים את אמיר'],['and continue to the party.','ולהמשיך למסיבה.']],
  [['Instead, she called the manager','במקום זאת היא התקשרה למנהלת'],['and admitted that the change','והודתה שהשינוי'],['had never been approved.','מעולם לא אושר.']],
  [['Roni reached the bakery late,','רוני הגיעה למאפייה באיחור,'],['after the manager had opened alone.','לאחר שהמנהלת פתחה לבדה.']],
  [['Amir arrived after practice,','אמיר הגיע לאחר האימון,'],['and they completed the shift form together.','והם מילאו יחד את טופס החלפת המשמרת.']],
  [['The next time Roni changed a shift,','בפעם הבאה שרוני החליפה משמרת,'],['she waited for the word “approved”','היא חיכתה למילה ״מאושר״'],['before changing her plans.','לפני ששינתה את תכניותיה.']]
 ],
 'new-3-a1-safety-rule':[
  [['A clear safety cover','מגן בטיחות שקוף'],['surrounded the sanding wheel','הקיף את גלגל השיוף'],['in the school workshop.','בסדנת בית הספר.']],
  [['The rule was simple:','הכלל היה פשוט:'],['switch off the machine','לכבות את המכונה'],['and wait for the wheel to stop.','ולהמתין עד שהגלגל יעצור.']],
  [['Students had followed it','התלמידים פעלו לפיו'],['for months without a problem.','במשך חודשים ללא בעיה.']],
  [['On Friday, Ben needed','ביום שישי בן היה צריך'],['to smooth one last edge','לשייף קצה אחרון'],['before the bell.','לפני הצלצול.']],
  [['He switched off the machine','הוא כיבה את המכונה'],['and reached for the cover','והושיט יד אל המגן'],['at once.','מיד.']],
  [['Maya held the cover closed.','מאיה החזיקה את המגן סגור.'],['“The wheel is still moving.”','״הגלגל עדיין נע.״']],
  [['The motor was quiet,','המנוע היה שקט,'],['but a red mark on the wheel','אך סימן אדום על הגלגל'],['continued to turn.','המשיך להסתובב.']],
  [['A small metal piece came loose','חתיכת מתכת קטנה השתחררה'],['and struck the inside','ופגעה בצדו הפנימי'],['of the clear cover.','של המגן השקוף.']],
  [['Ben stepped back','בן צעד לאחור'],['and stared at the new mark','ובהה בסימן החדש'],['on the plastic.','שעל הפלסטיק.']],
  [['The instructor unplugged the machine','המדריך ניתק את המכונה מן החשמל'],['and checked the clamp.','ובדק את המהדק.']],
  [['A worn screw','בורג שחוק'],['had allowed the metal piece','אפשר לחתיכת המתכת'],['to move.','לזוז.']],
  [['The class waited','הכיתה המתינה'],['until the red mark','עד שהסימן האדום'],['stopped completely.','נעצר לגמרי.']],
  [['The instructor replaced the screw','המדריך החליף את הבורג'],['before the cover was opened.','לפני שהמגן נפתח.']],
  [['Ben’s sign was not finished','השלט של בן לא הושלם'],['before the bell,','לפני הצלצול,'],['so he returned later.','ולכן הוא חזר מאוחר יותר.']],
  [['The next week,','בשבוע הבא,'],['he showed a new student','הוא הראה לתלמיד חדש'],['the red mark before lifting the cover.','את הסימן האדום לפני שהרים את המגן.']]
 ],
 'new-3-a1-week-without-movement':[
  [['On Sunday, Ron planned','ביום ראשון רון תכנן'],['to study four chapters','ללמוד ארבעה פרקים'],['at his desk.','ליד שולחנו.']],
  [['He placed food, water,','הוא הניח מזון, מים'],['and his phone beside the chair','ואת הטלפון ליד הכיסא'],['so he would not need to stand.','כדי שלא יצטרך לקום.']],
  [['After the first hour,','לאחר השעה הראשונה,'],['he skipped a walk with his father','הוא ויתר על הליכה עם אביו'],['to finish one more page.','כדי לסיים עוד עמוד.']],
  [['A short video break','הפסקת סרטון קצרה'],['lasted forty-five minutes,','נמשכה ארבעים וחמש דקות,'],['so Ron went to bed late.','ולכן רון הלך לישון מאוחר.']],
  [['On Monday, he sat through school','ביום שני הוא ישב במשך יום הלימודים'],['and returned to the same chair.','וחזר לאותו כיסא.']],
  [['His shoulders tightened.','כתפיו התקשו.'],['When a pencil fell,','כאשר עיפרון נפל,'],['he left it beside the chair.','הוא השאיר אותו ליד הכיסא.']],
  [['During Tuesday’s practice test,','במבחן התרגול ביום שלישי,'],['Ron read one question','רון קרא שאלה אחת'],['three times.','שלוש פעמים.']],
  [['He refused another walk','הוא סירב להליכה נוספת'],['because he was falling behind.','מפני שפיגר בחומר.']],
  [['On Wednesday,','ביום רביעי,'],['the teacher asked him','המורה ביקשה ממנו'],['to explain a simple answer.','להסביר תשובה פשוטה.']],
  [['Ron looked at his full notebook,','רון הביט במחברתו המלאה,'],['but his mind felt empty.','אך מוחו הרגיש ריק.']],
  [['His study chart showed','טבלת הלמידה שלו הראתה'],['more hours and fewer finished pages.','יותר שעות ופחות עמודים שהושלמו.']],
  [['A phone timer failed','טיימר בטלפון נכשל'],['because Ron stopped it','מפני שרון עצר אותו'],['without leaving the chair.','בלי לעזוב את הכיסא.']],
  [['He moved the alarm','הוא העביר את השעון המעורר'],['across the room','אל הצד השני של החדר'],['and wrote shorter study blocks.','וכתב מקטעי למידה קצרים יותר.']],
  [['When it rang,','כאשר צלצל,'],['he walked the stairs','הוא הלך במדרגות'],['for three minutes.','במשך שלוש דקות.']],
  [['By Friday, Ron had finished','עד יום שישי רון סיים'],['three chapters, not four,','שלושה פרקים, לא ארבעה,'],['but could explain the main ideas.','אך הצליח להסביר את הרעיונות המרכזיים.']],
  [['Before studying on Sunday,','לפני שלמד ביום ראשון,'],['he placed his walking shoes','הוא הניח את נעלי ההליכה שלו'],['beside the desk.','ליד השולחן.']]
 ],
 'new-3-a1-emergency-team':[
  [['Residents created','התושבים הקימו'],['a neighborhood emergency team.','צוות חירום שכונתי.']],
  [['Lina marked skills, equipment,','לינה סימנה מיומנויות, ציוד'],['and people who might need help','ואנשים שעשויים להזדקק לעזרה'],['on a street map.','על מפת הרחוב.']],
  [['At the first meeting,','במפגש הראשון,'],['everyone wanted to help,','כולם רצו לעזור,'],['but nobody had a clear role.','אך לאיש לא היה תפקיד ברור.']],
  [['Lina pointed','לינה הצביעה'],['to Mr. Barak’s apartment.','אל דירתו של מר ברק.']],
  [['“Who calls him','״מי מתקשר אליו'],['if the power fails?”','אם החשמל נפסק?״'],['she asked.','שאלה.']],
  [['The room became quiet.','החדר השתתק.']],
  [['The team divided the street','הצוות חילק את הרחוב'],['into small areas.','לאזורים קטנים.']],
  [['Each pair received','כל זוג קיבל'],['a contact list, a flashlight,','רשימת קשר, פנס'],['and one clear task.','ומשימה ברורה אחת.']],
  [['During the first practice,','במהלך התרגול הראשון,'],['one phone did not answer.','טלפון אחד לא נענה.']],
  [['The pair used the backup contact,','הזוג השתמש באיש הקשר החלופי,'],['and another volunteer found','ומתנדבת אחרת גילתה'],['a flashlight without batteries.','פנס ללא סוללות.']],
  [['They replaced the batteries','הם החליפו את הסוללות'],['and drew a side route','וסימנו מסלול צדדי'],['around a narrow gate.','מסביב לשער צר.']],
  [['On Friday evening,','ביום שישי בערב,'],['a fallen branch cut the power','ענף שנפל ניתק את החשמל'],['to two buildings.','בשני בניינים.']],
  [['The usual path was blocked,','הדרך הרגילה הייתה חסומה,'],['so Lina’s pair used','ולכן הזוג של לינה השתמש'],['the marked side route.','במסלול הצדדי המסומן.']],
  [['They reached Mr. Barak','הם הגיעו למר ברק'],['with the working flashlight','עם הפנס התקין'],['and the backup phone number.','ועם מספר הטלפון החלופי.']],
  [['He was safe,','הוא היה בטוח,'],['but his apartment was dark','אך דירתו הייתה חשוכה'],['and his phone had little power.','ובטלפון שלו נותר מעט כוח.']],
  [['The team brought a battery lamp','הצוות הביא מנורה הפועלת בסוללות'],['and passed updates','והעביר עדכונים'],['until the power returned.','עד שהחשמל חזר.']],
  [['At the next practice,','בתרגול הבא,'],['Lina checked the batteries','לינה בדקה את הסוללות'],['before giving any instructions.','לפני שנתנה הוראות כלשהן.']]
 ],
 'new-3-a1-public-meeting':[
  [['The city planned','העירייה תכננה'],['to move the bus stop','להעביר את תחנת האוטובוס'],['and add parking near the school.','ולהוסיף חניה ליד בית הספר.']],
  [['At the evening meeting,','בפגישת הערב,'],['the loudest speakers','הדוברים הקולניים ביותר'],['were local drivers.','היו נהגים מקומיים.']],
  [['Maya sat beside the stage','מאיה ישבה ליד הבמה'],['and marked each speaker','וסימנה כל דובר'],['with a colored dot.','בנקודה צבעונית.']],
  [['After twelve speeches,','לאחר שנים עשר נאומים,'],['ten dots belonged to drivers.','עשר נקודות היו של נהגים.']],
  [['“Nobody needs that stop,”','״איש אינו זקוק לתחנה הזאת,״'],['one driver said.','אמר אחד הנהגים.']],
  [['Maya’s pencil stopped.','העיפרון של מאיה נעצר.']],
  [['For three afternoons,','במשך שלושה אחר צהריים,'],['students had collected cards','תלמידים אספו כרטיסים'],['from people at the bus stop.','מאנשים בתחנת האוטובוס.']],
  [['Forty-six riders had written','ארבעים ושישה נוסעים כתבו'],['why they used it.','מדוע השתמשו בה.']],
  [['The chair announced','יושב הראש הודיע'],['that only one minute remained','שנותרה דקה אחת בלבד'],['for public comments.','להערות הציבור.']],
  [['Maya usually avoided microphones,','מאיה נמנעה בדרך כלל ממיקרופונים,'],['but she raised the map.','אך היא הרימה את המפה.']],
  [['The blue dots covered','הנקודות הכחולות כיסו'],['only one part of the neighborhood.','רק חלק אחד מן השכונה.']],
  [['She read a card','היא קראה כרטיס'],['from a cleaner','של עובדת ניקיון'],['who finished work after dark.','שסיימה לעבוד לאחר רדת החשכה.']],
  [['Another card came','כרטיס נוסף הגיע'],['from a student','מתלמיד'],['who traveled without a car.','שנסע בלי מכונית.']],
  [['Some drivers questioned the cards','כמה נהגים הטילו ספק בכרטיסים'],['because the writers','מפני שהכותבים'],['were not in the room.','לא היו בחדר.']],
  [['Maya asked the city planner','מאיה ביקשה ממתכנן העיר'],['to compare both groups','להשוות בין שתי הקבוצות'],['before the vote.','לפני ההצבעה.']],
  [['The planner delayed the decision','המתכנן דחה את ההחלטה'],['and tested a smaller parking area.','ובדק אזור חניה קטן יותר.']],
  [['The bus stop remained,','תחנת האוטובוס נשארה,'],['although the plan created','אף שהתכנית יצרה'],['two fewer parking spaces.','שני מקומות חניה פחות.']],
  [['At the next meeting,','בפגישה הבאה,'],['Maya gave the first microphone','מאיה נתנה את המיקרופון הראשון'],['to a bus rider.','לנוסע באוטובוס.']]
 ],
 'new-3-a2-recommendation-letter':[
  [['Tom asked his teacher','תום ביקש מן המורה שלו'],['for a recommendation','מכתב המלצה'],['to a youth leadership camp.','למחנה מנהיגות לנוער.']],
  [['He brought a draft','הוא הביא טיוטה'],['that called him','שכינתה אותו'],['an outstanding team leader.','מנהיג צוות מצטיין.']],
  [['Mr. Halevi remembered','מר הלוי זכר'],['Tom’s strong research','את המחקר החזק של תום'],['and two missed group deadlines.','ושני מועדים קבוצתיים שהחמיץ.']],
  [['The letter was due','המכתב היה צריך להישלח'],['the next morning.','למחרת בבוקר.']],
  [['“Every other applicant','״לכל מועמד אחר'],['will have a strong letter,”','יהיה מכתב חזק,״'],['Tom said.','אמר תום.']],
  [['The teacher wanted to help,','המורה רצה לעזור,'],['but his signature','אך חתימתו'],['would support every claim.','הייתה מאשרת כל טענה.']],
  [['He highlighted the sentence','הוא הדגיש את המשפט'],['he could not prove','שלא היה יכול להוכיח'],['and invited Tom to sit down.','והזמין את תום לשבת.']],
  [['Tom gripped the page.','תום אחז בדף בחוזקה.'],['“An honest letter may cost me the place.”','״מכתב כן עלול לעלות לי במקום.״']],
  [['They listed his real strengths:','הם רשמו את חוזקותיו האמיתיות:'],['careful research, clear explanations,','מחקר יסודי, הסברים ברורים'],['and steady improvement.','ושיפור מתמשך.']],
  [['The letter also described','המכתב תיאר גם'],['how Tom had begun using','כיצד תום החל להשתמש'],['a shared deadline calendar.','בלוח מועדים משותף.']],
  [['Tom chose the accurate version','תום בחר בגרסה המדויקת'],['without the leadership claim.','ללא טענת המנהיגות.']],
  [['The camp invited him to an interview','המחנה הזמין אותו לריאיון'],['and asked about teamwork.','ושאל על עבודת צוות.']],
  [['Before his next group project,','לפני הפרויקט הקבוצתי הבא שלו,'],['Tom sent the timeline','תום שלח את לוח הזמנים'],['before anyone reminded him.','לפני שמישהו הזכיר לו.']]
 ],
 'new-3-a2-unsafe-workplace':[
  [['Maya and Oren noticed','מאיה ואורן הבחינו'],['that a metal guard','שמגן מתכת'],['was missing from a packing machine.','חסר ממכונת אריזה.']],
  [['A maintenance note warned','פתק תחזוקה הזהיר'],['that its safety sensor','שחיישן הבטיחות שלה'],['sometimes failed.','נכשל לפעמים.']],
  [['Their supervisor said','המפקח שלהם אמר'],['the afternoon order was late','שההזמנה של אחר הצהריים איחרה'],['and told them to continue carefully.','ואמר להם להמשיך בזהירות.']],
  [['A piece of cardboard','חתיכת קרטון'],['caught beside the moving belt.','נתקעה ליד המסוע הנע.']],
  [['Oren reached toward it','אורן הושיט יד לעברה'],['before Maya hit','לפני שמאיה לחצה'],['the red stop button.','על כפתור העצירה האדום.']],
  [['The belt stopped,','המסוע נעצר,'],['but boxes piled up','אך ארגזים נערמו'],['behind the machine.','מאחורי המכונה.']],
  [['The supervisor asked them','המפקח ביקש מהם'],['to restart at a slower speed.','להפעיל מחדש במהירות נמוכה יותר.']],
  [['Maya refused','מאיה סירבה'],['and reported the missing guard','ודיווחה על המגן החסר'],['through the safety channel.','דרך ערוץ הבטיחות.']],
  [['A technician found','טכנאי מצא'],['a cracked sensor','חיישן סדוק'],['that would not always stop','שלא תמיד יעצור'],['for a hand or sleeve.','למראה יד או שרוול.']],
  [['The machine stayed closed','המכונה נשארה מושבתת'],['until a new guard arrived.','עד שהגיע מגן חדש.']],
  [['The team packed urgent orders by hand,','הצוות ארז הזמנות דחופות ביד,'],['and several deliveries were late.','וכמה משלוחים איחרו.']],
  [['The supervisor was angry,','המפקח כעס,'],['but the inspection confirmed','אך הבדיקה אישרה'],['that stopping was necessary.','שהעצירה הייתה נחוצה.']],
  [['The repaired machine received','המכונה שתוקנה קיבלה'],['a signed safety checklist.','רשימת בטיחות חתומה.']],
  [['On its first day back,','ביום הראשון לאחר שחזרה,'],['Oren pointed to every item','אורן הצביע על כל סעיף'],['before anyone pressed Start.','לפני שמישהו לחץ על ״הפעלה״.']]
 ],
 'new-3-a2-scholarship-application':[
  [['Amir opened a scholarship form','אמיר פתח טופס מלגה'],['for a school sports trip.','למסע ספורט של בית הספר.']],
  [['Without a large award,','ללא מלגה גדולה,'],['his family could not pay','משפחתו לא יכלה לשלם'],['the full fee.','את מלוא התשלום.']],
  [['A classmate pointed','חבר לכיתה הצביע'],['to the weekly care hours','על שעות הטיפול השבועיות'],['in the hardship section.','בסעיף הקושי.']],
  [['“Change six hours to sixteen,”','״שנה שש שעות לשש עשרה,״'],['he suggested.','הוא הציע.']],
  [['Amir typed the larger number','אמיר הקליד את המספר הגדול יותר'],['and watched his need score rise.','וראה את ציון הצורך שלו עולה.']],
  [['The next page requested','העמוד הבא ביקש'],['a schedule or family letter','מערכת שעות או מכתב משפחתי'],['for every claimed duty.','לכל אחריות שצוינה.']],
  [['Amir could prove six hours,','אמיר יכול היה להוכיח שש שעות,'],['not sixteen.','לא שש עשרה.']],
  [['Only twenty minutes remained','נותרו רק עשרים דקות'],['before the form closed.','לפני שהטופס נסגר.']],
  [['He deleted the false number','הוא מחק את המספר הכוזב'],['and described his real duties','ותיאר את חובותיו האמיתיות'],['and weekend work.','ואת עבודתו בסוף השבוע.']],
  [['He attached pay slips','הוא צירף תלושי שכר'],['and bus receipts','וקבלות אוטובוס'],['instead of a dramatic story.','במקום סיפור דרמטי.']],
  [['The committee awarded','הוועדה העניקה'],['a partial scholarship,','מלגה חלקית,'],['not the full amount.','לא את מלוא הסכום.']],
  [['Amir stared at the remaining fee','אמיר בהה בתשלום שנותר'],['and wondered whether honesty','ותהה אם הכנות'],['had cost him the trip.','עלתה לו במסע.']],
  [['A counselor used the bus receipts','יועצת השתמשה בקבלות האוטובוס'],['to find a separate travel grant.','כדי למצוא מענק נסיעה נפרד.']],
  [['The two awards covered','שתי המלגות כיסו'],['most of the fee,','את רוב התשלום,'],['but not all of it.','אך לא את כולו.']],
  [['At one school event,','באירוע בית ספרי אחד,'],['Amir checked names at the door','אמיר בדק שמות בכניסה'],['to cover the remaining fee.','כדי לכסות את התשלום שנותר.']],
  [['Before his next application,','לפני בקשתו הבאה,'],['Amir opened an evidence folder','אמיר פתח תיקיית ראיות'],['before writing any claim.','לפני שכתב טענה כלשהי.']]
 ],
 'new-3-a2-study-screen-balance':[
  [['Dana used one laptop','דנה השתמשה במחשב נייד אחד'],['for history research, messages,','למחקר בהיסטוריה, להודעות'],['and entertainment.','ולבידור.']],
  [['Its weekly report showed','הדוח השבועי שלו הראה'],['twenty-nine screen hours','עשרים ותשע שעות מסך'],['but not their purpose.','אך לא את מטרתן.']],
  [['Dana said most of the time','דנה אמרה שרוב הזמן'],['had been schoolwork.','הוקדש ללימודים.']],
  [['Her partner Lior opened','בן זוגה ליאור פתח'],['the browser history','את היסטוריית הדפדפן'],['beside their project plan.','לצד תכנית הפרויקט שלהם.']],
  [['Research pages were mixed','דפי מחקר התערבבו'],['with messages, games,','בהודעות, במשחקים'],['and short videos.','ובסרטונים קצרים.']],
  [['Their first log marked','היומן הראשון שלהם סימן'],['every session that began','כל זמן מסך שהתחיל'],['with a textbook as “study.”','עם ספר לימוד כ״למידה״.']],
  [['On Tuesday, one history tutorial','ביום שלישי סרטון לימודי אחד בהיסטוריה'],['led to comedy clips','הוביל לסרטוני קומדיה'],['for forty minutes.','במשך ארבעים דקות.']],
  [['Dana missed the start','דנה החמיצה את תחילתה'],['of the group call,','של השיחה הקבוצתית,'],['although her log still said “study.”','אף שהיומן שלה עדיין אמר ״למידה״.']],
  [['She and Lior created','היא וליאור יצרו'],['separate browser profiles','פרופילי דפדפן נפרדים'],['for study and free time.','ללמידה ולזמן פנוי.']],
  [['They downloaded needed sources','הם הורידו את המקורות הנחוצים'],['before opening the study profile.','לפני שפתחו את פרופיל הלמידה.']],
  [['One required tutorial','סרטון לימודי נדרש אחד'],['still appeared on the same platform','עדיין הופיע באותה פלטפורמה'],['as the comedy clips.','כמו סרטוני הקומדיה.']],
  [['Dana copied the direct link','דנה העתיקה את הקישור הישיר'],['into her notes','אל ההערות שלה'],['and closed the platform after it ended.','וסגרה את הפלטפורמה לאחר שהסתיים.']],
  [['After two days,','לאחר יומיים,'],['the new browser history showed','היסטוריית הדפדפן החדשה הראתה'],['ninety minutes of study.','תשעים דקות של למידה.']],
  [['It also showed','היא הראתה גם'],['forty-five minutes of entertainment,','ארבעים וחמש דקות של בידור,'],['not zero.','לא אפס.']],
  [['Dana admitted that total time','דנה הודתה שזמן כולל'],['had hidden the switching','הסתיר את המעבר'],['between purposes.','בין מטרות.']],
  [['The project was submitted on time,','הפרויקט הוגש בזמן,'],['but Dana still apologized','אך דנה עדיין התנצלה'],['for the group call she had missed.','על השיחה הקבוצתית שהחמיצה.']],
 [['On Friday, Dana closed','ביום שישי דנה סגרה'],['the study profile completely','לגמרי את פרופיל הלמידה'],['before opening a game.','לפני שפתחה משחק.']]
 ],
 'new-3-a2-limited-budget':[
  [['Neta placed twelve wooden tokens','נטע הניחה שנים עשר אסימוני עץ'],['beside three project cards.','לצד שלושה כרטיסי מיזמים.']],
  [['The community grant could fund','המענק הקהילתי יכול היה לממן'],['an accessible path,','שביל נגיש,'],['a garden,','גינה'],['or a quiet study corner.','או פינת לימוד שקטה.']],
  [['Neta had designed the garden','נטע תכננה את הגינה'],['and expected it to win.','וציפתה שהיא תיבחר.']],
  [['The study corner had support','פינת הלימוד זכתה לתמיכה'],['from sixty students','של שישים תלמידים'],['who lacked a calm place','שלא היה להם מקום שקט'],['after school.','לאחר הלימודים.']],
  [['The path served fewer people,','השביל שירת פחות אנשים,'],['but its broken slope','אך השיפוע הפגום שלו'],['forced wheelchair users','אילץ משתמשים בכיסאות גלגלים'],['through a back entrance.','לעבור דרך כניסה אחורית.']],
  [['At first, the committee ranked','בתחילה הוועדה דירגה'],['each card by popularity.','כל כרטיס לפי הפופולריות שלו.']],
  [['The garden led easily.','הגינה הובילה בקלות.']],
  [['Sara arrived ten minutes late','שרה הגיעה באיחור של עשר דקות'],['after waiting for a staff member','לאחר שהמתינה לאיש צוות'],['to unlock the back gate.','שיפתח את השער האחורי.']],
  [['“I can enter,” she said,','״אני יכולה להיכנס,״ אמרה,'],['“but never on my own.”','״אבל לעולם לא בכוחות עצמי.״']],
  [['Neta’s hand stayed','ידה של נטע נשארה'],['on the garden card.','על כרטיס הגינה.']],
  [['The group replaced popularity','הקבוצה החליפה את מדד הפופולריות'],['with four criteria: safety, access,','בארבעה קריטריונים: בטיחות, נגישות,'],['urgency, and number served.','דחיפות ומספר המשתמשים.']],
  [['The garden scored high','הגינה קיבלה ציון גבוה'],['for community benefit,','בתועלת לקהילה,'],['but its volunteers could wait','אך המתנדבים שלה יכלו להמתין'],['until spring.','עד האביב.']],
  [['The study corner could borrow','פינת הלימוד יכלה לשאול'],['tables and old headphones','שולחנות ואוזניות ישנות'],['for one term.','למשך תקופת לימודים אחת.']],
  [['Only the path removed','רק השביל הסיר'],['a daily barrier','מכשול יומיומי'],['that no volunteer could fix.','שאף מתנדב לא יכול היה לתקן.']],
  [['Neta moved her own card','נטע העבירה את הכרטיס שלה'],['below the path','אל מתחת לכרטיס השביל'],['and cast the deciding vote.','והטילה את הקול המכריע.']],
  [['The room became quiet','החדר השתתק'],['when the garden team','כאשר צוות הגינה'],['saw the result.','ראה את התוצאה.']],
  [['The committee published the scores','הוועדה פרסמה את הציונים'],['and named what would be delayed.','וציינה מה יידחה.']],
  [['A month later, Sara entered','חודש לאחר מכן שרה נכנסה'],['through the front path','דרך השביל הקדמי'],['without asking for a key.','בלי לבקש מפתח.']],
  [['Neta carried the unopened seed box','נטע נשאה את קופסת הזרעים הסגורה'],['to the next budget meeting.','אל ישיבת התקציב הבאה.']]
 ],
 'new-3-a2-long-term-solution':[
  [['For three Mondays,','במשך שלושה ימי שני,'],['a bucket had waited','המתין דלי'],['beneath the youth center’s leaking pipe.','מתחת לצינור הדולף במרכז הנוער.']],
  [['Each patch stopped the drip','כל טלאי עצר את הטפטוף'],['for only a few days.','לימים אחדים בלבד.']],
  [['Eyal wanted to seal it again','אייל רצה לאטום אותו שוב'],['before the evening basketball practice.','לפני אימון הכדורסל בערב.']],
  [['Maintenance worker Avi showed him','אבי, איש התחזוקה, הראה לו'],['three wet repair labels','שלוש תוויות תיקון רטובות'],['on the same joint.','על אותו חיבור.']],
  [['Rina measured the water','רינה מדדה את המים'],['collected overnight:','שנאספו במהלך הלילה:'],['twenty-two liters.','עשרים ושניים ליטרים.']],
  [['The pipe model on their table','דגם הצינורות שעל שולחנם'],['showed only one weak joint,','הראה רק חיבור חלש אחד,'],['so the leak seemed simple.','ולכן הדליפה נראתה פשוטה.']],
  [['Then Rina compared','ואז רינה השוותה'],['the times of each leak','את זמני כל דליפה'],['with the pressure log.','עם יומן הלחץ.']],
  [['Every failure followed','כל תקלה הופיעה לאחר'],['the automatic tank refill.','המילוי האוטומטי של המכל.']],
  [['Avi opened a wall panel','אבי פתח לוח בקיר'],['and found an old valve','ומצא שסתום ישן'],['forcing high pressure','שהזרים לחץ גבוה'],['into the newer pipe.','אל הצינור החדש יותר.']],
  [['Another patch would be cheap,','טלאי נוסף היה זול,'],['but the pressure would remain.','אך הלחץ היה נשאר.']],
  [['Replacing the valve and pipe','החלפת השסתום והצינור'],['would use the repair fund','הייתה מנצלת את תקציב התיקונים'],['and close the center','וסוגרת את המרכז'],['for one afternoon.','למשך אחר צהריים אחד.']],
  [['The basketball team had','לקבוצת הכדורסל היה'],['a tournament practice that day.','אימון לקראת טורניר באותו יום.']],
  [['Eyal suggested waiting','אייל הציע להמתין'],['until after the tournament.','עד לאחר הטורניר.']],
  [['A sharp knock shook the joint,','נקישה חדה הרעידה את החיבור,'],['and a thin spray','וסילון דק'],['crossed the basement floor.','חצה את רצפת המרתף.']],
  [['Eyal closed the main valve','אייל סגר את השסתום הראשי'],['before the spray reached','לפני שהסילון הגיע'],['the stacked equipment boxes.','אל ארגזי הציוד המוערמים.']],
  [['The practice was canceled,','האימון בוטל,'],['and several players','וכמה שחקנים'],['blamed the committee.','האשימו את הוועדה.']],
  [['Avi replaced the old valve,','אבי החליף את השסתום הישן,'],['the damaged pipe,','את הצינור הפגום'],['and added a pressure gauge.','והוסיף מד לחץ.']],
  [['The first tank refill','המילוי הראשון של המכל'],['moved the gauge','הזיז את מד הלחץ'],['but left the floor dry.','אך השאיר את הרצפה יבשה.']],
  [['One month later,','חודש לאחר מכן,'],['the water meter showed','מד המים הראה'],['no unexplained night use.','שלא הייתה צריכה לילית בלתי מוסברת.']],
  [['Eyal hung the empty bucket','אייל תלה את הדלי הריק'],['upside down,','כשהוא הפוך,'],['beside the completed repair log.','לצד יומן התיקון שהושלם.']]
 ],
 'new-3-es-conflict-interest':[
  [['Yonatan scored three bids for new study-room equipment.','Yonatan evaluated three companies that wanted to supply equipment for a new study room.']],
  [['One bid came from a company owned by his aunt, but he had told nobody on the committee.','One company belonged to Yonatan’s aunt, and the other committee members did not know about the family connection.']],
  [['He gave it the highest technical score and told himself the numbers were objective.','Yonatan ranked his aunt’s company first and believed that the score was based only on facts.']],
  [['During the final meeting, Liora noticed the same woman in a family photograph beside his folder.','Liora recognized the company owner in a family photograph near Yonatan’s papers.']],
  [['“Is she connected to this company?” she asked.','Liora asked whether the woman in the photograph had a connection to the company.']],
  [['Yonatan’s thumb covered the photograph while the other members waited.','Yonatan covered part of the photograph with his hand as the group waited for an answer.']],
  [['He could defend every score, yet his vote had broken a tie.','He could explain each score, but his vote had decided which company was leading.']],
  [['If he disclosed the connection, his aunt might lose the contract and blame him.','Telling the truth could cost his aunt the work and damage their relationship.']],
  [['If he stayed silent, the committee would sign that afternoon.','Keeping quiet would allow the group to approve the contract before anyone knew about his interest.']],
  [['Yonatan said, “She is my aunt, and I should have told you before scoring.”','Yonatan revealed the relationship and admitted that he should have disclosed it earlier.']],
  [['He placed his score sheet in the folder and left the table.','He removed himself and his score from the decision.']],
  [['The remaining members asked an outside teacher to rescore the bids without names.','An independent teacher reviewed the anonymous offers again.']],
  [['Another company won by two points because its repair plan was stronger.','A different company ranked first because it offered better long-term repairs.']],
  [['His aunt sent one angry message; Yonatan did not ask the committee to change its result.','Yonatan’s aunt was angry, but he did not use the family relationship to reopen the decision.']],
  [['At the next meeting, connection declarations were collected before any envelope was opened.','Future committee members had to reveal relevant connections before reviewing any offer.']]
 ],
 'new-3-es-incomplete-consent':[
  [['Five students agreed to a concentration study described as a twenty-minute music task.','Five students joined a short project that compared concentration with and without music.']],
  [['The form did not say that a camera would record their faces for later analysis.','The information sheet did not explain that the research team planned to record the participants on video.']],
  [['When the first task began, Amir noticed a green light above the laptop.','Amir saw a camera light turn on when the activity started.']],
  [['“Are you recording us?” he asked, raising his hand.','Amir stopped and asked whether the team was making a video.']],
  [['Project leader Dana said the videos would remain private and that the teacher had approved the study.','Dana answered that only the team would see the recordings and that an adult had approved the project.']],
  [['Amir answered that privacy was not the same as permission.','Amir explained that keeping a video private did not mean that participants had agreed to it.']],
  [['Another participant said she would not have joined if she had known.','A second student made clear that the missing information would have changed her choice.']],
  [['The science fair opened the next morning, and deleting the recordings would weaken the project.','The team needed results for the next day, and losing the videos would reduce its evidence.']],
  [['Dana’s partner suggested finishing the session and explaining afterward.','One team member wanted to continue first and provide the missing explanation later.']],
  [['Dana looked at the camera, then at the five forms with no video choice.','Dana saw that none of the signed forms included a decision about recording.']],
  [['She stopped the timer and covered the lens.','Dana ended the task and prevented any further recording.']],
  [['The team deleted the unapproved recordings while the participants watched.','The participants saw the team remove the videos that had been made without full consent.']],
  [['They rewrote the form with separate choices for the task, recording, and future use.','The new form allowed people to decide separately about participating, video, and later use of their data.']],
  [['Three students agreed to the task again; only one agreed to be recorded.','Most participants rejoined the activity, but only one freely accepted recording.']],
  [['The smaller sample could not support the result Dana had hoped to announce.','The reduced evidence was too weak for Dana’s planned conclusion.']],
  [['At the fair, she presented the consent error and the revised method instead of a strong conclusion.','Dana explained the mistake and the improved process instead of claiming a result the evidence could not support.']],
  [['The new forms included a recording box that every participant could mark or leave blank.','The final form made the recording choice visible and genuinely optional.']]
 ],
 'new-3-es-whistleblower-choice':[
  [['Dana, a student apprentice at a community workshop, found two versions of the monthly safety record.','Dana was learning at a workshop when she found two different copies of the same safety report.']],
  [['The official version removed three failed emergency-stop tests, although two internal reports had requested repairs.','The final report hid three failed safety tests even though workers had already asked for repairs.']],
  [['The machine behind the safety guard was scheduled to reopen before a large order that afternoon.','The workshop planned to use the guarded machine for an urgent job later that day.']],
  [['Dana showed both records to her supervisor.','Dana first reported the difference to the person responsible for her work.']],
  [['He called the difference a copying error and told her not to delay the shift.','The supervisor described it as a simple mistake and asked Dana to let the work continue.']],
  [['She sent a second internal report and received only an automatic reply.','Dana tried the normal reporting system again, but no person answered.']],
  [['A coworker warned that another shutdown would reduce everyone’s hours.','Another worker explained that closing the machine would also reduce the staff’s pay.']],
  [['Dana pictured fewer paid hours on next week’s schedule, then looked at the machine behind its metal guard.','Dana thought about losing paid work while she considered the danger behind the protective barrier.']],
  [['Staying silent protected the order and her new placement.','Silence would protect the urgent job and Dana’s opportunity at the workshop.']],
  [['Reporting beyond the usual chain could expose the altered record and her identity.','Using an independent channel could reveal the hidden information and also reveal who had reported it.']],
  [['She copied no private files; she listed the record numbers, dates, and failed tests she had been assigned to check.','Dana recorded only the safety facts that belonged to her work and did not take unrelated information.']],
  [['Dana sealed that list in the workshop’s protected safety box.','She used the confidential channel created for serious safety concerns.']],
  [['An independent safety officer arrived before the machine restarted.','A safety officer outside Dana’s management team examined the machine before it returned to service.']],
  [['During the test, the emergency button failed once in four attempts.','The inspection proved that the stop control did not work every time.']],
  [['The workshop closed the machine for two days, and the urgent order left late.','The repair protected workers but delayed the important order and reduced available work.']],
  [['Some coworkers avoided Dana, although the repaired switch prevented a risk they could now see.','Not everyone supported Dana, even after the hidden danger became clear.']],
  [['No public praise followed; she completed the smaller hand-packing shift beside them.','Dana received no celebration and continued doing the limited work that remained.']],
  [['When the machine returned, Dana compared the signed test time with the real clock before adding her initials.','Dana’s later action showed that she would verify a safety record before accepting responsibility for it.']]
 ],
 'new-3-es-biased-selection':[
  [['The youth-program panel gave every applicant the same online reasoning test.','Every person applying to the youth program received identical questions.']],
  [['After scoring, every accepted card carried a blue morning clip, while most orange afternoon cards were rejected.','The results strongly favored the morning group even though test time was unrelated to ability.']],
  [['Chair Eli said identical questions proved the process was neutral.','Eli believed that using one test was enough to make the selection fair.']],
  [['Maya asked why test time predicted the outcome better than the applicants’ work samples.','Maya noticed that the session explained the results better than evidence connected to ability.']],
  [['The panel opened the activity log for both sessions.','The group checked exactly what had happened during the morning and afternoon tests.']],
  [['Morning applicants had used the library’s wired computers.','The morning group had taken the test on stable school computers.']],
  [['Afternoon applicants had used tablets in a room with unstable Wi-Fi.','The afternoon group had depended on a weak wireless connection.']],
  [['The timer continued while several diagrams were still loading.','Some students lost test time because the clock did not stop when pictures failed to appear.']],
  [['One strong applicant had lost six minutes before the final page appeared.','The record showed that a high-performing applicant had waited six minutes for part of the test.']],
  [['The result emails were scheduled to leave in twenty minutes.','The panel had very little time before the decisions would be sent.']],
  [['Eli feared that stopping them would make the panel look careless.','Correcting the problem would require the group to admit that its process had failed.']],
  [['Maya clipped an orange marker to her own card and repeated the test on the weak connection.','Maya tested the afternoon conditions herself instead of only discussing them.']],
  [['She ran out of time with two correct solutions still written on scrap paper.','The connection delay prevented Maya from entering answers she had already solved correctly.']],
  [['The panel canceled the emails and offered every affected applicant a supervised retest.','The group stopped the decision and created an equal second test for the afternoon applicants.']],
  [['Two morning candidates complained that a second chance changed the rules.','Some original finalists believed the correction was unfair to them.']],
  [['After the retest, three orange-card scores rose enough to enter the final group.','Three afternoon applicants performed well enough under equal conditions to become finalists.']],
  [['Two original finalists lost their places, so the correction carried a real cost.','Repairing the unfair process changed the result for people who had expected to be selected.']],
  [['The panel replaced the timed loading pages with printed diagrams and one shared clock.','The new test removed the connection delay and used the same visible time for everyone.']],
  [['Scores now matched the work samples more closely than the session color.','The revised results agreed more closely with evidence of each applicant’s actual work.']],
  [['Before the next selection, Maya stacked the cards by score and left every colored clip in a separate box.','The later process kept session labels away from the evidence used for selection.']]
 ],
 'new-3-es-controls-next-hour':[
  [['A study platform predicted which notification would keep Yoni online after each task.','A digital study service learned which alert was most likely to hold Yoni’s attention.']],
  [['By the time he noticed the pattern, small choices had already consumed most of his planned hour.','Yoni did not recognize the influence until many quick reactions had used almost all of his study time.']],
  [['Yoni had promised his group to finish the opening of their history presentation.','His classmates were waiting for him to complete the first part of a shared project.']],
  [['He opened one source on his laptop and left his phone beside the notebook.','Yoni began the work but kept the device that delivered the alerts within reach.']],
  [['A streak warning appeared just as he reached the end of the first paragraph.','The platform offered a reward-related alert at a natural stopping point.']],
  [['He checked it, answered one comment, and followed a recommended clip.','One quick response led to another activity that he had not planned.']],
  [['Each action produced another alert that seemed more urgent than the unfinished sentence.','The system continued offering new reasons to delay the work.']],
  [['When Hila arrived for the group call, thirty-seven minutes had passed and the slide was blank.','Yoni’s repeated reactions created a real cost for the classmates who depended on him.']],
  [['Yoni blamed himself for having no self-control.','He first treated the problem only as a personal weakness.']],
  [['Hila compared her phone and saw a different alert timed to her own habits.','Hila discovered that the platform used a different kind of message to attract her attention.']],
  [['The same platform had learned that she returned for message replies, not video streaks.','The service adjusted its method to the behavior of each user.']],
  [['They opened the notification history and drew the chain from the first alert to the missed call.','The students traced how one prompt had produced a sequence of unplanned actions.']],
  [['Deleting the app would block a required tutorial, so a complete escape was not practical.','They still needed part of the platform for school, which made a total ban unrealistic.']],
  [['They wrote one purpose and one stopping time on paper before logging in again.','Yoni and Hila made their intention visible before entering the service.']],
  [['Nonessential alerts were disabled, and both phones went into boxes beside an hourglass.','They removed avoidable prompts and placed the phones beyond immediate reach.']],
  [['Halfway through the next session, Yoni reached toward the box when no sound had occurred.','Yoni discovered that the habit continued even without a new alert.']],
  [['He stopped with his hand over the lid and asked, “Who chose this next minute?”','Yoni paused at the moment of action and questioned whether the next choice was truly his.']],
  [['The hourglass emptied before he reopened the box, and the group completed the introduction.','The external stopping point helped the students finish the promised task first.']],
  [['Yoni lost his viewing streak and felt more annoyed than he expected.','Regaining control still carried a small emotional cost because the platform’s reward had felt valuable.']],
  [['That evening, he watched one planned clip for fun and closed the platform when his timer ended.','Yoni did not reject entertainment; he chose its purpose and ending in advance.']],
  [['The next study hour began with the phones already inside the boxes.','Their later preparation showed that the changed behavior continued.']]
 ],
 'new-3-es-good-intention':[
  [['Eitan published a photograph of a struggling family beside a class food-drive appeal.','Eitan shared a family photograph because he wanted to collect food and money for them.']],
  [['Donations arrived quickly, but the family photograph spread far beyond the original group.','The appeal succeeded while the private image reached many people who were never meant to see it.']],
  [['He had taken the picture during a delivery and never asked whether it could be posted.','The family had allowed a photograph during the visit but had not agreed to public sharing.']],
  [['The image showed the parents, their younger daughter, and enough background details for neighbors to identify them.','Even without names, the picture contained enough information to reveal the family.']],
  [['Eitan told himself the family would forgive the post because the boxes were filling.','He used the successful donations to avoid facing the missing permission.']],
  [['By lunch, three students had sent the picture to groups outside school.','Classmates extended the loss of control by sharing the image again.']],
  [['The daughter stayed home after classmates questioned her about the photograph.','The public attention affected the child directly and made her avoid school.']],
  [['Her mother asked the counselor to remove the appeal immediately.','The family clearly withdrew any possible permission to keep using the photograph.']],
  [['Eitan’s fingers tightened around the phone as he watched the donation total rise.','His physical reaction showed the conflict between the campaign’s success and the harm it caused.']],
  [['Deleting the post might slow the drive before the Friday deadline.','Removing the effective appeal could reduce the aid that the family still needed.']],
  [['Leaving it online would keep using the family’s privacy as a fundraising tool.','Continuing the campaign would make the family pay for help with unwanted exposure.']],
  [['Eitan removed the photograph and wrote that sharing it had been wrong.','He stopped the immediate harm and accepted responsibility in the same place where he had posted the image.']],
  [['He contacted every group he could identify and asked them to delete the copy.','Eitan followed the spread as far as possible instead of treating one deletion as a complete repair.']],
  [['Some copies remained, and the family did not accept his apology at once.','The repair could not erase every image or restore trust immediately.']],
  [['The counselor offered the family control over what, if anything, could be shared.','The next step returned decision-making to the people receiving help.']],
  [['They approved a short list of needed items with no names, photograph, grade, or medical details.','The family chose a limited message that explained the need without identifying them.']],
  [['The class continued the drive through sealed boxes and private grocery cards.','Students kept helping through methods that did not turn the family into a public story.']],
  [['Fewer people shared the new appeal, but enough food arrived by Friday.','The more respectful campaign spread less widely but still met the urgent need.']],
  [['Eitan helped sort tins and oil without photographing the table.','His later action showed that he could help without creating content about the family.']],
  [['The family accepted the supplies through the counselor, not in front of the class.','The delivery protected the family from another public scene.']],
  [['The daughter returned to school, but she passed Eitan without speaking.','The practical repair did not require the hurt person to forgive him immediately.']],
  [['For the next collection, he placed the camera in his pocket before opening the storeroom.','Eitan changed his behavior before the same temptation could return.']],
  [['The new box carried only an item list and a closing date.','The final collection made the need visible while keeping the receiving family private.']]
 ],
 'l3-a2-food-waste':[
...
'new-2-a2-false-emergency-message':[
  ...
  [['Neta compared the screenshot','נטע השוותה את צילום המסך'],['with the empty notice board','ללוח המודעות הריק'],['outside the office.','מחוץ למשרד.']],
  [['Omer called and said','עומר התקשר ואמר'],['his father had already turned','שאביו כבר סובב'],['the car around.','את המכונית וחזר.']],
  [['While the guard phoned the principal,','בזמן שהשומר התקשר למנהלת,'],['Neta checked the school’s official page.','נטע בדקה את הדף הרשמי של בית הספר.']],
  [['At 6:47, it still showed','בשעה 6:47 הוא עדיין הציג'],['the normal opening time.','את שעת הפתיחה הרגילה.']],
  [['“Maybe the page is late,”','״אולי הדף לא עודכן,״'],['Omer said,','אמר עומר,'],['and Neta gripped her phone.','ונטע אחזה בטלפון בחוזקה.']],
  [['At 6:51, the principal confirmed','בשעה 6:51 המנהלת אישרה'],['that no leak had been reported.','שלא דווח על שום דליפה.']],
  [['Neta posted the official notice','נטע פרסמה את ההודעה הרשמית'],['and asked classmates to delete','וביקשה מחבריה לכיתה למחוק'],['the false warning.','את האזהרה הכוזבת.']],
  [['Omer’s father had missed','אביו של עומר כבר החמיץ'],['the highway exit,','את היציאה מהכביש המהיר,'],['so Omer reached choir practice','ולכן עומר הגיע לחזרת המקהלה'],['twenty minutes late.','באיחור של עשרים דקות.']],
  [['The office posted a clear correction','המשרד פרסם תיקון ברור'],['before the regular buses arrived.','לפני שהאוטובוסים הרגילים הגיעו.']],
  [['A week later,','שבוע לאחר מכן,'],['Neta checked the sender and date','נטע בדקה את השולח ואת התאריך'],['before forwarding another urgent message.','לפני שהעבירה הודעה דחופה נוספת.']]
 ],
'new-2-a2-accessible-sports-day':[
  [['Tal’s sports-day map offered','מפת יום הספורט של טל הציעה'],['points only for running,','נקודות רק על ריצה,'],['jumping, and climbing.','קפיצה וטיפוס.']],
  [['During the field test,','במהלך הבדיקה במגרש,'],['Yaara’s wheelchair stopped','כיסא הגלגלים של יערה נעצר'],['at a narrow starting gate.','בשער זינוק צר.']],
  [['Tal offered her','טל הציע לה'],['the job of keeping time.','את תפקיד מדידת הזמנים.']],
  [['“I came to compete,','״באתי להתחרות,'],['not only to count,”','לא רק לספור,״'],['Yaara replied.','השיבה יערה.']],
  [['Tal’s face grew warm;','פניו של טל הסמיקו;'],['he had changed her role','הוא שינה את תפקידה'],['without asking her.','בלי לשאול אותה.']],
  [['The organizers asked Yaara','המארגנים ביקשו מיערה'],['to test a wider route','לבדוק מסלול רחב יותר'],['between blue cones.','בין קונוסים כחולים.']],
  [['Her wheel struck a yellow cone','הגלגל שלה פגע בקונוס צהוב'],['because the first turn','מפני שהסיבוב הראשון'],['was still too tight.','עדיין היה צר מדי.']],
  [['Yaara moved two cones','יערה הזיזה שני קונוסים'],['and completed the slalom','והשלימה את מסלול העקלתון'],['without touching one.','בלי לגעת באף אחד מהם.']],
  [['She proposed three equal-point stations:','היא הציעה שלוש תחנות בניקוד שווה:'],['the slalom, a ball target,','מסלול העקלתון, מטרת כדור,'],['and a team relay.','ומרוץ שליחים קבוצתי.']],
  [['One organizer called flexible scoring unfair','אחד המארגנים טען שניקוד גמיש אינו הוגן'],['because teams would choose','מפני שקבוצות יבחרו'],['different tasks.','משימות שונות.']],
  [['Yaara asked him','יערה ביקשה ממנו'],['to test every station','לבדוק כל תחנה'],['before deciding.','לפני שיחליט.']],
  [['He missed the ball target twice','הוא החטיא פעמיים את מטרת הכדור'],['and saw that each choice','וראה שכל בחירה'],['required skill.','דרשה מיומנות.']],
  [['On sports day, each team chose','ביום הספורט כל קבוצה בחרה'],['a route, but every member','מסלול, אך כל חבר בקבוצה'],['completed an active part.','השלים חלק פעיל.']],
  [['Yaara’s team lost time','הקבוצה של יערה איבדה זמן'],['in the slalom,','במסלול העקלתון,'],['won points at the target,','זכתה בנקודות במטרת הכדור,'],['and finished second.','וסיימה במקום השני.']],
  [['At the next planning meeting,','בפגישת התכנון הבאה,'],['Tal handed Yaara the map','טל מסר ליערה את המפה'],['and asked where to begin.','ושאל היכן להתחיל.']]
 ],
'new-2-a2-community-survey':[
  [['The student council needed','מועצת התלמידים נזקקה'],['a plan for an empty lot.','לתכנית עבור מגרש ריק.']],
  [['Lior’s online survey received','הסקר המקוון של ליאור קיבל'],['seventy-eight answers;','שבעים ושמונה תשובות;'],['sixty favored a sports court.','שישים העדיפו מגרש ספורט.']],
  [['The group celebrated','הקבוצה חגגה'],['and colored one tall bar','וצבעה עמודה גבוהה אחת'],['on its chart.','בתרשים שלה.']],
  [['Dana checked the addresses','דנה בדקה את הכתובות'],['and found fifty-two responses','ומצאה חמישים ושתיים תשובות'],['from Tamar Street.','מרחוב תמר.']],
  [['That street bordered the lot,','הרחוב הזה גבל במגרש,'],['and the survey link','והקישור לסקר'],['had circulated only there.','הופץ רק שם.']],
  [['“The result may still be right,”','״ייתכן שהתוצאה עדיין נכונה,״'],['Lior said;','אמר ליאור;'],['“the meeting is tomorrow.”','״הפגישה מחר.״']],
  [['They placed colored tokens','הם הניחו אסימונים צבעוניים'],['on a neighborhood map;','על מפת השכונה;'],['one entire side remained empty.','צד שלם אחד נשאר ריק.']],
  [['The group spent the afternoon','הקבוצה בילתה את אחר הצהריים'],['at the market,','בשוק,'],['the senior center, and the playground.','במרכז לאזרחים ותיקים ובמגרש המשחקים.']],
  [['An older resident','תושבת מבוגרת'],['could not scan the code,','לא הצליחה לסרוק את הקוד,'],['so Lior recorded her answer','ולכן ליאור רשם את תשובתה'],['on paper.','על נייר.']],
  [['A parent said','אחד ההורים אמר'],['the question pushed people','שהשאלה דחפה אנשים'],['toward one answer.','לעבר תשובה אחת.']],
  [['They replaced it with the question,','הם החליפו אותה בשאלה:'],['“Which use would help you most?”','״איזה שימוש יעזור לכם ביותר?״']],
  [['The new answers favored shade','התשובות החדשות העדיפו צל'],['and benches,','וספסלים,'],['although many teenagers','אף שבני נוער רבים'],['still wanted a court.','עדיין רצו מגרש.']],
  [['The group kept the first results','הקבוצה שמרה את התוצאות הראשונות'],['but marked the sample','אך סימנה שהמדגם'],['as limited.','מוגבל.']],
  [['At the meeting,','בפגישה,'],['Lior presented both sets','ליאור הציג את שתי קבוצות הנתונים'],['and explained how the method changed.','והסביר כיצד השיטה השתנתה.']],
  [['The council funded shaded seating first','המועצה מימנה תחילה אזור ישיבה מוצל'],['and a smaller practice wall','וקיר אימון קטן יותר'],['for a later trial.','לניסוי מאוחר יותר.']],
  [['Before the next survey,','לפני הסקר הבא,'],['Lior spread the tokens','ליאור פיזר את האסימונים'],['across the whole map','על פני המפה כולה'],['before opening the chart.','לפני שפתח את התרשים.']]
 ],
'new-2-a2-sitting-all-afternoon':[
  [['On Sunday afternoon,','ביום ראשון אחר הצהריים,'],['Yael opened her laptop','יעל פתחה את המחשב הנייד שלה'],['to finish five history slides.','כדי לסיים חמש שקופיות בהיסטוריה.']],
  [['Her phone beside the book','הטלפון שלה לצד הספר'],['lit up every few minutes.','נדלק כל כמה דקות.']],
  [['After ninety minutes,','לאחר תשעים דקות,'],['she had rewritten the same sentence','היא כתבה מחדש את אותו משפט'],['three times.','שלוש פעמים.']],
  [['Her tea was cold,','התה שלה היה קר,'],['and her shoulders ached.','וכתפיה כאבו.']],
  [['“I will move after this,”','״אני אזוז אחרי זה,״'],['she told herself,','אמרה לעצמה,'],['then opened one short video.','ואז פתחה סרטון קצר אחד.']],
  [['The next video started automatically','הסרטון הבא התחיל אוטומטית'],['and pushed the homework','ודחק את שיעורי הבית'],['farther into the evening.','עמוק יותר אל תוך הערב.']],
  [['At dinner,','בארוחת הערב,'],['Yael could not explain','יעל לא הצליחה להסביר'],['the paragraph she had just read.','את הפסקה שזה עתה קראה.']],
  [['She also missed','היא גם החמיצה'],['a planned walk with her cousin.','הליכה מתוכננת עם בת דודתה.']],
  [['The next day,','למחרת,'],['she set a twenty-five-minute timer','היא כיוונה טיימר לעשרים וחמש דקות'],['but kept the phone beside her.','אך השאירה את הטלפון לצדה.']],
  [['A new message hid the timer,','הודעה חדשה הסתירה את הטיימר,'],['so Yael missed the signal.','ולכן יעל החמיצה את האות.']],
  [['When the first plan failed,','כאשר התכנית הראשונה נכשלה,'],['Yael noticed that the phone','יעל הבחינה שהטלפון'],['was both timer and distraction.','שימש גם כטיימר וגם כהסחת דעת.']],
  [['She wrote three slide tasks','היא כתבה שלוש מטלות לשקופיות'],['on paper','על נייר'],['and put the phone','והכניסה את הטלפון'],['in a box across the room.','לקופסה בצד השני של החדר.']],
  [['After each slide,','לאחר כל שקופית,'],['she stood, drank water,','היא עמדה, שתתה מים,'],['and walked for three minutes.','והלכה במשך שלוש דקות.']],
  [['The first break felt unnecessary,','ההפסקה הראשונה נראתה מיותרת,'],['but afterward she found','אך אחריה היא מצאה'],['a wrong date immediately.','מיד תאריך שגוי.']],
  [['She completed four slides;','היא השלימה ארבע שקופיות;'],['the lost time left','הזמן שאבד השאיר'],['the last one for morning.','את האחרונה לבוקר.']],
  [['That evening,','באותו ערב,'],['she kept the phone boxed','היא השאירה את הטלפון בקופסה'],['and joined her cousin outside.','והצטרפה לבת דודתה בחוץ.']],
  [['On Tuesday,','ביום שלישי,'],['Yael felt her shoulders tighten','יעל הרגישה שכתפיה מתקשות'],['and reached for her walking shoes','והושיטה יד לנעלי ההליכה שלה'],['before another video.','לפני סרטון נוסף.']]
 ],
'new-2-es-answer-behind-answer':[
  [['For a science presentation, Eden asked an AI system a question: Had cafeteria waste fallen after a tray change?','Eden used a digital tool to ask whether changing the trays had reduced waste in the cafeteria.']],
  [['The system answered “thirty-eight percent” and listed three sources.','The tool gave an exact number and showed three places that seemed to support it.']],
  [['Eden placed the figure','Eden trusted the number'],['on the first slide','because the answer'],['because the wording sounded certain.','sounded confident.']],
  [['During rehearsal,','Maya asked'],['Maya asked which earlier amount','what earlier number'],['they had used','they were using'],['as the baseline.','for comparison.']],
  [['Eden opened the first source; it measured waste from homes in another country.','The first source studied waste in homes somewhere else, not their cafeteria.']],
  [['The second link mentioned cafeterias but never measured the new trays.','The second source discussed cafeterias but did not test the change in their school.']],
  [['He wanted to keep the clean slide and check the details later.','Eden was tempted to keep the attractive slide and delay the difficult checking.']],
  [['Amit placed a colored card beside every claim the group could prove.','Amit used colored cards to mark only statements supported by evidence.']],
  [['Evidence supported only two claims','The group could support only two'],['out of six.','of its six statements.']],
  [['They weighed waste from two school days and checked the caretaker’s records.','They collected their own measurements and compared them with school records.']],
  [['Packaging had fallen, but unfinished food had risen, so total waste had barely changed.','There was less packaging but more uneaten food, and the total stayed almost the same.']],
  [['Eden replaced the answer with their calculation and stated its limits.','Eden used the group’s own result and explained what it could not prove.']],
  [['At the presentation, Eden linked each record to the conclusion; the AI number stayed in his notes, marked “unverified.”','Eden explained every step, and he kept the tool’s unsupported number only as a warning in his notes.']]
 ],
'new-2-es-selective-report':[
  [['Maya prepared a school-board report','Maya wrote about'],['about a four-week peer-tutoring trial.','a short program in which students helped other students study.']],
  [['Her first chart showed that quiz scores had risen during the opening two weeks.','The first graph showed better scores at the beginning of the program.']],
  [['She removed the final two bars after attendance and scores declined.','Maya left out the later results because fewer students attended and scores fell.']],
  [['A positive report might secure','A successful-looking report could help'],['funding for a full-year program.','the program receive funding.']],
  [['Ben opened the spreadsheet and found eleven students missing from the summary.','Ben saw that the report did not include results from eleven students.']],
  [['“If we include them, the trial will look weak,” Maya said; the board meeting was an hour away.','Maya feared that complete information would make the program seem unsuccessful just before the meeting.']],
  [['Ben showed her the promise they had written: every result would be reported.','Ben reminded Maya that they had promised to include all the evidence.']],
  [['She restored the missing bars, and the chart became mixed instead of impressive.','Maya returned the missing results, so the graph showed both improvement and failure.']],
  [['They discovered that two sessions had overlapped with a sports tournament, reducing attendance by half.','Two tutoring sessions had low attendance because a school sports event happened at the same time.']],
  [['The revised report displayed attendance and scores together; it hid neither measure.','The new report showed both how many students came and how well they performed.']],
  [['It described improvement among regular participants but did not claim that tutoring alone caused it.','The report showed a possible benefit but did not pretend to prove the cause.']],
  [['When the board asked why the chart had changed, Maya admitted that she had removed the failures.','Maya told the board that she had first hidden the disappointing results.']],
  [['The board rejected immediate expansion but funded a smaller second trial with attendance tracking.','The program did not receive full funding, but it received money for another careful test.']],
  [['In the next report folder, Maya placed a blank page for limits before the page for results.','Maya made space for weaknesses before she began writing the next set of findings.']]
 ],
'new-2-es-algorithm-recommendation':[
  [['Sami researched digital homework','Sami used the school system'],['for a debate','to find information for a debate'],['on the school platform.','about online homework.']],
  [['Its first six recommendations all praised digital tools.','The system’s first suggestions all supported the same side.']],
  [['He assumed most evidence agreed and drafted a confident opening.','Sami believed the agreement was broad and wrote as if the issue were settled.']],
  [['On her account, Laila searched for digital homework and received warnings about privacy and access.','Laila used the same topic but saw sources about different risks.']],
  [['They placed both screens side by side; their leading results shared only one source.','Comparing the screens showed that the two accounts had received very different information.']],
  [['Sami checked his history and found two earlier clicks on pro-technology videos.','Sami saw that his past choices had favored one point of view.']],
  [['Each later recommendation had moved closer to that same position.','The suggestions had slowly become more similar to what he had clicked before.']],
  [['The system had not invented evidence, but it had narrowed the doorway to it.','The information was real, but the system had limited which part was easiest to see.']],
  [['They searched the library catalogue with neutral terms and followed references from the original studies.','They used a broader search method and checked where each study came from.']],
  [['Each student chose a source that challenged their view and summarized it fairly.','Sami and Laila each explained evidence that challenged their own view.']],
  [['One positive study involved schools with strong internet, while one critical study examined a remote area.','The studies described different conditions, so neither result applied everywhere.']],
  [['Their argument became conditional rather than certain.','They changed a simple claim into an argument that depended on the situation.']],
  [['At the debate, Sami explained that recommendations reflected earlier clicks, not the complete field.','Sami told the audience that personalized suggestions were not the same as all available evidence.']],
  [['The opposing team used one of their sources, and the debate remained close.','Sharing broader evidence made the competition more balanced and difficult.']],
  [['Afterward, Laila created a class list mixing sources from several viewpoints.','Laila saved useful sources from several viewpoints for other students.']],
  [['Sami began the next project by typing a question into the catalogue instead of opening “Recommended for You.”','Sami changed his first action so the system’s easiest suggestions would not control his search.']]
 ],
'new-2-es-confidential-conversation':[
  [['After club, Lia told Niv','Lia privately told Niv'],['about an older student','that another student was frightening her'],['who waited at her bus stop','online and near her bus stop'],['and sent threatening messages.','with threatening messages.']],
  [['She asked him to tell nobody because she feared classmates would share the screenshots and call her dramatic.','Lia wanted privacy because she feared gossip and public judgment.']],
  [['Niv promised to keep','Niv agreed too quickly'],['the conversation secret','without thinking'],['before considering the danger','about the danger'],['of complete silence.','of complete silence.']],
  [['That night, one new message named the bus Lia planned to take the next morning.','A later message showed that the other student knew Lia’s travel plan.']],
  [['Niv reread Lia’s request for silence and gripped the edge of his folder.','Niv felt the pressure of his promise while thinking about Lia’s safety.']],
  [['Silence protected her confidence, while sharing the entire chat would expose private details.','Keeping quiet and revealing everything would each protect one value but harm another.']],
  [['The next morning,','Niv did not spread the story;'],['Niv asked Lia','he asked Lia'],['to choose one trusted adult','to help choose the right person'],['and approach that person together.','and approach that person together.']],
  [['Lia said she was angry that he might break the promise, but she chose the school counselor.','Lia disliked changing the promise, yet she selected an adult she trusted.']],
  [['During the meeting, she froze when the counselor asked what needed immediate attention.','Lia found it difficult to explain the most urgent facts.']],
  [['Niv gave the counselor','Niv shared only'],['a blue note listing','the facts needed'],['the bus number and threat time,','to explain the safety risk,'],['but none of their private details.','not their private conversation.']],
  [['He left the room while Lia explained which other details she wanted kept private.','Lia controlled the parts of the story that did not need to be shared.']],
  [['The counselor placed an adult','The counselor took limited action'],['at the stop','at the bus stop'],['and told the safety lead.','and told only one responsible school leader.']],
  [['They documented the exact threatening messages and kept the screenshots out of class groups.','The evidence was protected instead of being spread among students.']],
  [['The unwanted contact stopped while the school reviewed the report.','Lia was no longer approached while responsible adults examined what had happened.']],
  [['Later Lia said, “I am still upset that you could not keep everything secret.”','Lia remained hurt even though the action had improved her safety.']],
  [['Niv answered, “I wanted you safe, and I should have explained that before promising.”','Niv accepted that his careless promise had created an additional cost.']],
  [['When someone later requested absolute secrecy, Niv promised careful privacy and help choosing a safe adult, not silence about danger.','Niv learned to offer privacy without promising to ignore a serious safety risk.']]
 ],
'new-2-es-late-evidence':[
  [['The student committee','A group of students'],['was about to select','was nearly ready'],['two regional science-fair projects.','to choose two projects for a larger competition.']],
  [['Rina’s project ranked third after she lost points for missing a required interview.','Rina received a penalty because the committee believed she had not attended an interview.']],
  [['Chair Daniel defended the rule; the fair allowed only two entries.','Daniel said the attendance rule mattered because only two projects could advance.']],
  [['The result cards were printed, and the candidates were waiting outside.','The committee had prepared its decision but had not announced it yet.']],
  [['Yael opened an envelope that had been delivered to the wrong classroom.','Yael found late information inside an envelope sent to another room.']],
  [['The sign-in sheet showed Rina at the original laboratory by three o’clock.','The record proved that Rina had arrived at the first interview location on time.']],
  [['The room-change email had been sent to a different student with the same first name.','The committee had sent the new location to the wrong person.']],
  [['Daniel suggested recording the mistake for next year because the decision was already prepared.','Daniel first wanted to protect the finished work instead of reopening it.']],
  [['Yael asked whether convenience mattered more than correcting their own error.','Yael challenged the group to consider the cost of ignoring the new facts.']],
  [['The committee removed the absence penalty and recalculated every score.','They corrected the mistake and checked all the results again.']],
  [['Rina moved into second place, while Amir fell to third by one point.','The correction helped Rina but cost Amir a place in the fair.']],
  [['They checked the totals twice and confirmed that the new order was accurate.','The group repeated the calculation before changing the decision.']],
  [['Daniel looked for an extra place,','The committee tried to add another project,'],['but the fair rules allowed none.','but the rules did not allow it.']],
  [['He called Amir in first and explained that the committee’s error had changed his result.','Daniel told Amir the full reason before announcing anything publicly.']],
  [['Amir stayed silent, then asked to see the scoring sheet.','Amir was disappointed and wanted to examine the evidence himself.']],
  [['After reading it, he said, “I hate the result, but the numbers are clear.”','Amir did not like the decision, yet he accepted that the corrected evidence supported it.']],
  [['Daniel set aside the printed cards and announced the revised choices.','The chair replaced the prepared decision with the accurate one.']],
  [['Rina accepted the place but admitted that the penalty had nearly discouraged her from applying again.','The correction could not remove the doubt caused by the first mistake.']],
  [['For the next selection, Daniel checked the envelope tray before signing any result, and every schedule change required a receipt.','The committee changed its process so late or misdirected information would be harder to miss.']]
 ],
'new-2-es-designed-attention':[
  [['In media class, Ido said people stayed too long on video platforms because they lacked self-control.','Ido blamed users for watching longer than they intended.']],
  [['Sivan asked him to test one platform during a fifteen-minute study break.','Sivan invited Ido to see how the platform affected his own choices.']],
  [['They placed a small hourglass beside the tablet.','They used an object outside the screen to show when the break should end.']],
  [['As the last sand fell, a reward badge appeared and the next clip began.','The platform offered a reward at the exact moment Ido had planned to stop.']],
  [['Ido tapped it without looking at the clock.','Ido continued automatically instead of checking his plan.']],
  [['After Ido set the tablet down, an alert called him back to an unfinished series.','A notification encouraged him to return even after he had stopped.']],
  [['Twelve minutes later,','The extended break'],['he missed the group task’s beginning.','created a real cost for Ido’s classmates.']],
  [['Embarrassed, he blamed the application; Sivan replied, “You tapped, but the timing was not an accident.”','Sivan said Ido had chosen to tap, but the design had made that choice harder.']],
  [['The class examined design notes showing that alerts were scheduled near common exit points.','The evidence showed that the platform studied when many users were likely to leave.']],
  [['Ido’s confident criticism softened as he watched his own recording.','Seeing his behavior changed the way Ido judged other users.']],
  [['They disabled autoplay, reward badges, and nonessential notifications.','The students removed features that made it easy to continue without deciding.']],
  [['During a second test, the screen stopped changing when the hourglass emptied.','The changed settings created a clear stopping moment.']],
  [['Ido still reached toward the tablet before noticing his hand.','The habit remained even after the strongest digital prompts were removed.']],
  [['This time, the empty hourglass gave him an external reason to pause.','The physical timer helped Ido remember the decision he had made earlier.']],
  [['Sivan made three colored cards: “purpose,” “stop time,” and “next task.”','The cards asked users to decide why, when, and what came after the screen session.']],
  [['Before opening the platform, each student placed completed cards beside the tablet.','The class made its plan visible before entering a system designed to hold attention.']],
  [['Ido chose one tutorial and twenty minutes; when the sand ended, he closed the cover.','Ido followed a specific plan instead of waiting for the platform to stop him.']],
  [['He lost a seven-day viewing streak and felt unexpectedly annoyed.','Stopping had a small emotional cost because the platform had made the streak feel valuable.']],
  [['That evening, he finished the group summary on time and left the tablet facedown.','Ido’s later action showed that the new plan supported his responsibility to the group.']],
  [['When another student blamed “weak users,” Ido turned the hourglass and asked, “What is the design trying to make them do?”','Ido no longer judged the user without also examining the system.']]
 ]
};
const narrativeMetadata={
 'new-3-a1-first-job-interview':{
  arcEn:'Preparation pays off',arcHe:'הכנה מוקדמת מוכיחה את עצמה',
  lesson:'הכנה לריאיון אינה רק שינון תשובות. שאלה ברורה, הודאה במה שעדיין לא יודעים והדגמה של יכולת ללמוד עשויות להיות חשובות יותר מהעמדת פנים של ביטחון.',
  lessonEn:'Interview preparation is more than memorizing answers. A clear question, an honest admission of what is not yet known, and a demonstrated ability to learn can matter more than pretending to be certain.'
 },
 'new-3-a1-shift-exchange':{
  arcEn:'Race against time',arcHe:'מרוץ נגד הזמן',
  lesson:'המילה ״כנראה״ בהודעה פרטית אינה אישור להחלפת משמרת. תקשורת ברורה עם המנהל, הודאה בטעות וקבלת מחיר האיחור מגינות על עמיתים ועל מקום העבודה.',
  lessonEn:'The word “probably” in a private message is not approval for a shift exchange. Clear communication with the manager, admission of error, and acceptance of delay protect coworkers and the workplace.'
 },
 'new-3-a1-safety-rule':{
  arcEn:'Rescue or intervention',arcHe:'חילוץ או התערבות',
  lesson:'כלל בטיחות חשוב דווקא כאשר המנוע כבר שקט והסיכון קשה לראות. שמירת המגן סגור, המתנה לעצירה מלאה ובדיקת חלק שחוק עלולות לעכב את העבודה, אך מונעות מחיפזון להפוך לפגיעה.',
  lessonEn:'A safety rule matters precisely when the motor is already quiet and the remaining risk is hard to see. Keeping the guard closed, waiting for a complete stop, and checking a worn part may delay the work but prevent haste from becoming injury.'
 },
 'new-3-a1-week-without-movement':{
  arcEn:'Chain reaction',arcHe:'תגובת שרשרת',
  lesson:'עוד זמן ליד השולחן אינו מבטיח עוד למידה כאשר הוא דוחק שינה ותנועה. מקטעי למידה קצרים, קימה ממשית והפסקות תנועה יכולים לשפר הבנה גם אם לא מסיימים כל עמוד שתוכנן.',
  lessonEn:'More time at a desk does not guarantee more learning when it replaces sleep and movement. Shorter study blocks, actually standing up, and movement breaks can improve understanding even when not every planned page is completed.'
 },
 'new-3-a1-emergency-team':{
  arcEn:'Preparation pays off',arcHe:'הכנה מוקדמת מוכיחה את עצמה',
  lesson:'רצון לעזור אינו מספיק בלי תפקידים, אנשי קשר חלופיים וציוד שנבדק. תרגול שמגלה טלפון לא זמין, סוללות חסרות ומסלול חסום מאפשר לפעול באופן מסודר כאשר החשמל באמת נפסק.',
  lessonEn:'Willingness to help is not enough without roles, backup contacts, and checked equipment. A drill that reveals an unanswered phone, missing batteries, and a blocked route supports organized action when the power truly fails.'
 },
 'new-3-a1-public-meeting':{
  arcEn:'Unexpected ability',arcHe:'יכולת מפתיעה',
  lesson:'הקולות הרמים בחדר אינם בהכרח מייצגים את כל מי שיושפע מהחלטה. מיפוי המשתתפים, איסוף עמדות ממי שלא הגיע ומתן מקום לקול שקט יכולים להרחיב את הראיות לפני הצבעה.',
  lessonEn:'The loudest voices in a room do not necessarily represent everyone affected by a decision. Mapping participants, collecting views from absent users, and making room for a quiet voice can widen the evidence before a vote.'
 },
 'new-3-a2-recommendation-letter':{
  arcEn:'Moral dilemma',arcHe:'דילמה בין ערכים',
  lesson:'מכתב המלצה צריך לעזור לתלמיד בלי לאשר טענה שהמורה אינו יכול להוכיח. תיאור חוזקות אמיתיות וצמיחה נראית לעין שומר על אמינות ומציע לתלמיד בסיס ממשי להמשך.',
  lessonEn:'A recommendation should support a student without asking the teacher to endorse an unprovable claim. Describing genuine strengths and visible growth protects credibility and gives the student a real basis for further development.'
 },
 'new-3-a2-unsafe-workplace':{
  arcEn:'Rescue or intervention',arcHe:'חילוץ או התערבות',
  lesson:'לחץ להספיק הזמנה אינו מבטל מגן חסר או חיישן פגום. עצירת המכונה, סירוב להפעלה מחדש ודיווח בערוץ מוסדר יוצרים עיכוב ממשי, אך מגינים על עובדים לפני שמתרחשת פגיעה.',
  lessonEn:'Pressure to complete an order does not cancel a missing guard or a faulty sensor. Stopping the machine, refusing an unsafe restart, and reporting through a formal channel create real delay but protect workers before injury occurs.'
 },
 'new-3-a2-scholarship-application':{
  arcEn:'Temptation and consequence',arcHe:'פיתוי ותוצאה',
  lesson:'הגזמה בבקשת מלגה עלולה להעניק יתרון על חשבון מועמד אחר ולהתפרק כאשר נדרשות ראיות. הצגה מדויקת של צורך אינה מבטיחה מימון מלא, אך מאפשרת סיוע הוגן שאפשר להצדיק.',
  lessonEn:'Exaggeration in a scholarship application can create an advantage at another applicant’s expense and collapse when evidence is required. An accurate account does not guarantee full funding, but it supports fair aid that can be justified.'
 },
 'new-3-a2-study-screen-balance':{
  arcEn:'Discovery',arcHe:'גילוי בעקבות בדיקה',
  lesson:'מספר כולל של שעות מסך אינו מגלה אם הזמן שימש ללמידה, הודעות או בידור. היסטוריה מפורטת, הפרדת סביבות ושמירה על זמן פנוי גלוי מאפשרות ליצור איזון מדיד במקום איסור שאינו מציאותי.',
  lessonEn:'A total screen-time number does not show whether time served study, messages, or entertainment. Detailed history, separated environments, and visible free time create measurable balance instead of an unrealistic ban.'
 },
 'new-3-a2-limited-budget':{
  arcEn:'Moral dilemma',arcHe:'דילמה בין ערכים',
  lesson:'החלטת תקציב הוגנת אינה מסתכמת בספירת תומכים. קריטריונים גלויים של בטיחות, נגישות, דחיפות ותועלת, יחד עם הקשבה למי שנושא במחיר, מאפשרים לבחור צורך חיוני בלי להסתיר אילו מיזמים חשובים יידחו.',
  lessonEn:'A fair budget decision is more than a popularity count. Public criteria for safety, access, urgency, and benefit, together with the voice of the person carrying the cost, support an essential choice without hiding which valuable projects must wait.'
 },
 'new-3-a2-long-term-solution':{
  arcEn:'Search for an explanation',arcHe:'חיפוש אחר הסבר',
  lesson:'תיקונים חוזרים עלולים להסתיר תקלה מערכתית. השוואת יומני לחץ, מדידת בזבוז ובדיקת הדגם מצדיקות עלות התחלתית והשבתה מתוכננת כאשר הן מסירות את הסיבה לתקלה ולא רק את הסימן הנראה לעין.',
  lessonEn:'Repeated patches can hide a system failure. Comparing pressure logs, measuring waste, and testing a model can justify an initial cost and a planned shutdown when they remove the cause rather than only the visible symptom.'
 },
 'new-3-es-conflict-interest':{
  arcEn:'Secret revealed',arcHe:'סוד שנחשף',
  lesson:'גם ניקוד שנראה מקצועי אינו מבטל קשר משפחתי שלא נחשף. גילוי מוקדם, נסיגה מן ההצבעה ובדיקה עצמאית מגינים הן על ההחלטה והן על אמון הציבור, גם כאשר התוצאה פוגעת באדם קרוב.',
  lessonEn:'A professional-looking score does not cancel an undisclosed family connection. Early disclosure, withdrawal from the vote, and independent review protect both the decision and public trust, even when the outcome disappoints someone close.'
 },
 'new-3-es-incomplete-consent':{
  arcEn:'Mistake and repair',arcHe:'טעות ותיקון',
  lesson:'אישור מבוגר ושמירת מידע בפרטיות אינם תחליף להסכמה מדעת. כאשר מידע מהותי חסר, יש לעצור, להסיר חומר שנאסף ללא רשות ולתת בחירה נפרדת וברורה לכל שימוש, גם אם הראיות שנותרות חלשות יותר.',
  lessonEn:'Adult approval and private storage are not substitutes for informed consent. When important information is missing, responsible repair means stopping, removing material collected without permission, and offering a separate clear choice for each use, even if the remaining evidence is weaker.'
 },
 'new-3-es-whistleblower-choice':{
  arcEn:'Moral dilemma',arcHe:'דילמה בין ערכים',
  lesson:'דיווח בטיחות אחראי אינו מחייב פרסום פומבי או לקיחת מידע שאינו שייך למשימה. תיעוד מדויק ושימוש בערוץ מוגן עשויים לעכב עבודה ולגבות מחיר חברתי, אך הם מאפשרים בדיקה עצמאית לפני שסיכון מוסתר הופך לפגיעה.',
  lessonEn:'Responsible safety reporting does not require public exposure or taking information unrelated to the task. Accurate documentation through a protected channel may delay work and carry a social cost, but it enables independent review before a hidden risk becomes an injury.'
 },
 'new-3-es-biased-selection':{
  arcEn:'False appearance',arcHe:'מראית עין מטעה',
  lesson:'אותן שאלות אינן מבטיחות תנאים שווים כאשר החיבור, המכשיר או הזמן פועלים אחרת. בדיקת תבנית התוצאות, שחזור התנאים ומתן מבחן חוזר הוגן מתקנים את ההליך, גם כאשר מועמדים שכבר ציפו להתקבל מאבדים את מקומם.',
  lessonEn:'Identical questions do not guarantee equal conditions when connection, device, or time behaves differently. Examining outcome patterns, reproducing the conditions, and offering a fair retest repair the process, even when candidates who expected selection lose their places.'
 },
 'new-3-es-controls-next-hour':{
  arcEn:'Chain reaction',arcHe:'תגובת שרשרת',
  lesson:'התראה אחת יכולה להתחיל שרשרת בחירות שהמערכת למדה לעודד. מיפוי השרשרת, הגדרת מטרה וזמן עצירה מראש, השתקת התראות והרחקת הטלפון אינם מבטלים בחירה אישית; הם מחזירים לה מקום לפני שההרגל פועל.',
  lessonEn:'One alert can begin a chain of choices that a platform has learned to encourage. Mapping the chain, naming a purpose and stop time, silencing prompts, and moving the phone do not remove personal choice; they restore room for it before habit takes over.'
 },
 'new-3-es-good-intention':{
  arcEn:'Mistake and repair',arcHe:'טעות ותיקון',
  lesson:'כוונה לעזור אינה יוצרת רשות לפרסם אדם אחר. תיקון אחראי כולל הסרת התמונה, מעקב אחר השיתופים, החזרת השליטה למשפחה והמשך הסיוע בלי פרטים מזהים; גם אז אי־אפשר לדרוש סליחה מיידית או למחוק כל עותק.',
  lessonEn:'A wish to help does not create permission to publish another person. Responsible repair includes removing the image, following its shares, returning control to the family, and continuing aid without identifying details; even then, immediate forgiveness and complete deletion cannot be demanded.'
 },
 'new-3-a2-first-bell':{
  arcEn:'Help from a friend',arcHe:'קבלת עזרה מחבר',
  lesson:'שליטה באנגלית אינה מבטלת את הצורך בעזרה בשפה ובנהלים מקומיים. הצעה ממוקדת שאינה משתלטת, הודאה שקטה בקושי והעברת אותה עזרה לתלמיד הבא הופכות מבוכה לעצמאות ולסיוע הדדי.',
  lessonEn:'Fluent English does not remove the need for help with local language and routines. Specific support that does not take over, a quiet admission of difficulty, and passing the same help to the next newcomer turn embarrassment into independence and mutual aid.'
 },
 'new-3-es-unanswered-message':{
  arcEn:'Misunderstanding',arcHe:'אי־הבנה שמתבהרת',
  lesson:'שתיקה בקבוצה יכולה להיווצר מפיזור אחריות ולהיראות כדחייה מכוונת. הכרה פומבית בהחמצה, ניסוח תכניות ברור ומימוש ההזמנה במעשה מתקנים את הקשר בלי לצפות מהתלמיד החדש לשאול שוב ושוב.',
  lessonEn:'Group silence can result from shared carelessness and still feel like deliberate rejection. Publicly naming the miss, writing plans clearly, and turning an invitation into real action repair the relationship without requiring the newcomer to keep asking.'
 },
 'new-3-es-winter-stage':{
  arcEn:'Role reversal',arcHe:'היפוך תפקידים',
  lesson:'ניסיון בדיבור מול קהל אינו מבטל קושי בהוראות במה לא מוכרות. תמיכה מצומצמת ותרגול בונים עצמאות, וכאשר המערכת קורסת אותה עצמאות מאפשרת ללומדת להחזיק את האירוע עד שהמסייעת משלימה את התיקון.',
  lessonEn:'Public-speaking experience does not remove difficulty with unfamiliar stage cues. Limited support and practice build independence, and when the system fails, that independence allows the learner to hold the event together while the helper completes the repair.'
 },
 'new-1-a2-one-scooter-two-friends':{
 ...
 'new-2-a2-false-emergency-message':{
  arcEn:'Race against time',arcHe:'מרוץ נגד הזמן',
  lesson:'הודעה דחופה עלולה ללחוץ על תלמידים לשתף לפני בדיקה. בדיקת השולח, התאריך והמקור הרשמי, לצד תיקון ברור באותו מקום, יכולה לעצור פחד מיותר גם אם אינה מבטלת איחור שכבר נגרם.',
  lessonEn:'An urgent message can pressure students to share before checking. Verifying the sender, date, and official source and posting a clear correction in the same place can stop unnecessary fear even when an earlier delay cannot be undone.'
 },
 'new-2-a2-accessible-sports-day':{
  arcEn:'Shared task, changed relationship',arcHe:'משימה משותפת שמשנה יחסים',
  lesson:'נגישות אינה תפקיד צדדי שנבחר עבור תלמיד אחר. שיתוף המשתתפים בתכנון, בדיקת המסלול ושמירה על אתגר פעיל מאפשרים ליצור אפשרויות שונות בלי להניח מראש מי מסוגל להתחרות.',
  lessonEn:'Accessibility is not a side role chosen for another student. Involving participants in planning, testing the course, and preserving active challenge creates different options without assuming who is able to compete.'
 },
 'new-2-a2-community-survey':{
  arcEn:'Discovery',arcHe:'גילוי בעקבות רמזים',
  lesson:'מספר גדול אינו מייצג קהילה שלמה כאשר רוב התשובות מגיעות ממקום אחד והשאלה מכוונת לתוצאה. מיפוי המדגם, ניסוח ניטרלי והצגת המגבלות מאפשרים לשנות המלצה בלי להסתיר את הסקר הראשון.',
  lessonEn:'A large number does not represent a whole community when most answers come from one place and the question pushes toward one result. Mapping the sample, using neutral wording, and showing limits support a better recommendation without hiding the first survey.'
 },
 'new-2-a2-sitting-all-afternoon':{
  arcEn:'Second attempt',arcHe:'כישלון וניסיון שני',
  lesson:'טיימר באותו טלפון שמסיח את הדעת אינו תמיד מספיק. פירוק המשימה, הרחקת הטלפון והפסקות תנועה קצרות יוצרים ניסיון שני מעשי יותר, גם כאשר הזמן שכבר אבד משאיר עבודה לבוקר.',
  lessonEn:'A timer on the same distracting phone is not always enough. Breaking down the task, moving the phone away, and taking short movement breaks create a more workable second attempt even when lost time leaves work for the morning.'
 },
 'new-2-es-answer-behind-answer':{
  arcEn:'Search for an explanation',arcHe:'חיפוש אחר הסבר',
  lesson:'תשובה מדויקת למראה אינה אמינה כאשר המקורות אינם תומכים בטענה והלומד אינו יכול להסביר את בסיס החישוב. בדיקת כל שלב, איסוף נתונים עצמאיים וציון מגבלות הופכים תוצאה להבנה.',
  lessonEn:'A precise-looking answer is not reliable when its sources do not support the claim and the learner cannot explain the baseline. Checking every step, gathering independent data, and stating limits turn a result into understanding.'
 },
 'new-2-es-selective-report':{
  arcEn:'Promise under pressure',arcHe:'הבטחה תחת לחץ',
  lesson:'הבטחה לדווח את כל התוצאות נבחנת כאשר נתונים מאכזבים עלולים לפגוע במימון. הצגת נוכחות, הישגים ומגבלות יחד עשויה לצמצם תכנית, אך יוצרת בסיס אמין יותר לניסוי הבא.',
  lessonEn:'A promise to report every result is tested when disappointing data may threaten funding. Showing attendance, outcomes, and limits together may reduce a program’s immediate scope, but it creates a more trustworthy basis for the next trial.'
 },
 'new-2-es-algorithm-recommendation':{
  arcEn:'False appearance',arcHe:'מראית עין מטעה',
  lesson:'רשימת המלצות דומה אינה הוכחה להסכמה רחבה; היא עשויה לשקף לחיצות קודמות ותנאים שונים. חיפוש במונחים ניטרליים, חזרה למחקרים והצגה הוגנת של מקור חולק מרחיבים את שדה הראיות.',
  lessonEn:'A uniform recommendation list is not proof of broad agreement; it may reflect earlier clicks and differing conditions. Neutral searches, original studies, and fair summaries of disagreeing sources widen the field of evidence.'
 },
 'new-2-es-confidential-conversation':{
  arcEn:'Moral dilemma',arcHe:'דילמה בין ערכים',
  lesson:'פרטיות ובטיחות הן שתיהן חובות חשובות, אך הבטחת סודיות מוחלטת עלולה להשאיר אדם בסכנה. בחירת מבוגר יחד, מסירת המידע ההכרחי בלבד והודאה במחיר של שינוי ההבטחה מגנות על שני הערכים ככל האפשר.',
  lessonEn:'Privacy and safety are both important duties, but a promise of absolute secrecy can leave someone in danger. Choosing a trusted adult together, sharing only necessary facts, and acknowledging the cost of changing the promise protect both values as far as possible.'
 },
 'new-2-es-late-evidence':{
  arcEn:'Mistake and repair',arcHe:'טעות ותיקון',
  lesson:'ראיה מאוחרת דורשת פתיחה מחדש של החלטה כאשר הטעות שייכת לתהליך עצמו. בדיקה חוזרת, הסבר אישי למי שנפגע ושינוי מנגנון מסירת המידע מתקנים את ההליך בלי להעמיד פנים שאין מחיר לתוצאה החדשה.',
  lessonEn:'Late evidence requires reopening a decision when the process itself caused the error. Recalculation, a direct explanation to the person who loses out, and a changed delivery system repair the procedure without pretending that the corrected result has no cost.'
 },
 'new-2-es-designed-attention':{
  arcEn:'Role reversal',arcHe:'היפוך תפקידים',
  lesson:'מי שמאשים משתמשים בחוסר שליטה עשוי לגלות עד כמה תזמון, תגמולים והתראות מעצבים גם את בחירותיו. הסרת טריגרים, קביעת מטרה ונקודת עצירה חיצונית משאירות אחריות אצל המשתמש בלי להתעלם מלחץ המערכת.',
  lessonEn:'A person who blames users for weak control may discover how timing, rewards, and alerts shape their own choices. Removing triggers, setting a purpose, and using an external stopping cue preserve user responsibility without ignoring system pressure.'
 },
 'l2-a2-rumor':{
  arcEn:'False appearance',arcHe:'מראית עין מטעה',
