...
| מס׳ קבוע | מזהה מלא | כותרת באנגלית | כותרת בעברית | שכבת גיל | קבוצה | סצנות | עטיפה פעילה | upgradedCovers | סיוע | ביקורת לשונית | ביקורת חזותית | הערה פנימית |
|---|---|---|---|---|---|---:|---|:---:|---|---|---|---|
| RA-013 | `l2-a2-photo-spread` | The Photograph That Spread | התמונה שהופצה | ח׳–ט׳ | A2 | 11 | `story-covers-v3/photo-spread.webp` | כן | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
| RA-014 | `l2-a2-cheating` | The Friend Who Cheated | החבר שהעתיק | ח׳–ט׳ | A2 | 12 | `story-covers-v3/cheating.webp` | כן | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
| RA-015 | `l2-a2-injured-captain` | The Injured Captain | הקפטן שנפצע | ח׳–ט׳ | A2 | 14 | `story-covers-v3/injured-captain.webp` | כן | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
...
| מס׳ קבוע | מזהה מלא | כותרת באנגלית | כותרת בעברית | שכבת גיל | קבוצה | סצנות | עטיפה פעילה | upgradedCovers | סיוע | ביקורת לשונית | ביקורת חזותית | הערה פנימית |
|---|---|---|---|---|---|---:|---|:---:|---|---|---|---|
| RA-016 | `l2-es-strength` | A Different Kind of Strength | סוג אחר של כוח | ח׳–ט׳ | ES | 13 | `story-covers-v3/strength.webp` | כן | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
| RA-017 | `l2-es-food-project` | The Community Food Project | מיזם המזון הקהילתי | ח׳–ט׳ | ES | 14 | `story-covers-v3/food-project.webp` | כן | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
| RA-018 | `l2-es-river` | The River After the Storm | הנהר לאחר הסערה | ח׳–ט׳ | ES | 16 | `story-covers-v3/river.webp` | כן | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
...
| מס׳ קבוע | מזהה מלא | כותרת באנגלית | כותרת בעברית | שכבת גיל | קבוצה | סצנות | עטיפה פעילה | upgradedCovers | סיוע | ביקורת לשונית | ביקורת חזותית | הערה פנימית |
|---|---|---|---|---|---|---:|---|:---:|---|---|---|---|
| RA-019 | `l3-a1-final-place` | The Final Place on the Team | המקום האחרון בנבחרת | ט׳–י׳ | A1 | 12 | `story-covers-v3/final-place.webp` | כן | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
| RA-020 | `l3-a1-park` | Saving the Neighborhood Park | מצילים את הפארק השכונתי | ט׳–י׳ | A1 | 13 | `story-covers-v3/park.webp` | כן | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟨 קובץ תקני; ידנית לא מתועדת | — |
