...
>
> עודכן: 23.8.2026 · מקור הנתונים: ה-runtime הסופי לאחר טעינת `catalog.js`, `additional-stories.js` ו-`story-rewrites.js` בקומיט בסיס `0e3a2495d947a859a159857988ffd7e3b79da2f2` ובתוספת תיקוני אצוות הביקורת המתועדות בענף העבודה.
...
| RA-021 | `l3-a1-empty-seat` | The Empty Seat | הכיסא הריק | ט׳–י׳ | A1 | 15 | `scenes/scene-02.webp` | לא | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפה גנרית משותפת; 362×362 |
...
| מס׳ קבוע | מזהה מלא | כותרת באנגלית | כותרת בעברית | שכבת גיל | קבוצה | סצנות | עטיפה פעילה | upgradedCovers | סיוע | ביקורת לשונית | ביקורת חזותית | הערה פנימית |
|---|---|---|---|---|---|---:|---|:---:|---|---|---|---|
| RA-022 | `l3-a2-anonymous-account` | The Anonymous Account | החשבון האנונימי | ט׳–י׳ | A2 | 13 | `story-scenes/l3-a2-anonymous-account/00.webp` | לא | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפת legacy ייעודית; 480×540 |
| RA-023 | `l3-a2-volunteer-truth` | The Truth About the Volunteer Project | האמת על מיזם ההתנדבות | ט׳–י׳ | A2 | 14 | `scenes/scene-00.webp` | לא | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפה גנרית משותפת; 362×362 |
| RA-024 | `l3-a2-repair-cafe` | The Repair Café | סדנת התיקונים הקהילתית | ט׳–י׳ | A2 | 16 | `story-scenes/l3-a2-repair-cafe/00.webp` | לא | עברית | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפת legacy ייעודית; 480×540 |
...
| מס׳ קבוע | מזהה מלא | כותרת באנגלית | כותרת בעברית | שכבת גיל | קבוצה | סצנות | עטיפה פעילה | upgradedCovers | סיוע | ביקורת לשונית | ביקורת חזותית | הערה פנימית |
|---|---|---|---|---|---|---:|---|:---:|---|---|---|---|
| RA-025 | `l3-es-promise` | The Promise to a Friend | ההבטחה לחבר | ט׳–י׳ | ES | 15 | `scenes/scene-08.webp` | לא | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפה גנרית משותפת; 362×362 |
| RA-026 | `l3-es-winning` | The Price of Winning | מחיר הניצחון | ט׳–י׳ | ES | 17 | `scenes/scene-04.webp` | לא | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפה גנרית משותפת; 362×362 |
| RA-027 | `l3-es-neighborhood-plan` | A Better Plan for the Neighborhood | תכנית טובה יותר לשכונה | ט׳–י׳ | ES | 18 | `scenes/scene-04.webp` | לא | Simple English | 🟨 שכתוב פעיל; ידנית לא מתועדת | 🟥 שדרוג 3:2 וביקורת ידנית ממתינים | עטיפה גנרית משותפת; 362×362 |
